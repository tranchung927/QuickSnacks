...
<div class="cate">
    <div class="container-fluid">
      <div class="cate-header d-flex my-4 like">
        <h3>Món Mới<i class="fa-solid fa-chevron-right mx-2"></i></h3>
        <hr>
      </div>
    </div>
    <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-lg-4">
                       ...
                       <?php 
                            if(isset($_SESSION['login']['username'])){
                                echo "<div class='btn_button d-flex justify-content-between my-3 pb-4'>
                                                   <button type='button' class='btn  btn-outline-dark rounded-pill px-md-2 btn_product'><a class='nav-link text-decoration-none' href='index.php?controller=category&action=product&id=<?php echo $products[$s]['id'] ?>Tuỳ chỉnh</a></button> 
                                                   <button type='button' class='btn btn-danger rounded-pill px-md-2 btn_product'>Thêm</button>
                                               </div>";
                            }else {
                                echo "<div class='d-flex justify-content-center bp-4'>
                                                   <button type='button' class='btn btn-danger rounded-pill px-4 mt-2 button my-4'>
