...
<head>
  ...
  <title>QuickSnacks | AdminPage</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="index.php?action=dashboard" class="logo">
        ...
        <span class="logo-lg"><b>Quick</b>Snacks<b>Admin</b></span>
      </a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span class="hidden-xs"><?php echo $_SESSION['admin']['last_name'] ?></span>
              </a>
              <ul class="dropdown-menu">
                <!-- User image -->
                <li class="user-header">
                  ...
                  <p>
                    <?php echo $_SESSION['admin']['last_name'] ?> - Web Developer
    ...
    function logout(){
      $.ajax({
        ...
        success : function (result){
          location.replace('http://localhost/QuickSnacks/admin');
        }
      });
    }
  </script>
